...
\usepackage[plainruled,linesnumbered,algochapter,vlined]{algorithm2e}
...
\setCJKfamilyfont{boldsong}{Source Han Serif SC Bold}
\newcommand{\boldsong}{\CJKfamily{boldsong}}
\setCJKfamilyfont{hei}{SimHei}
\newcommand{\hei}{\CJKfamily{hei}}

%\setCJKmainfont{Source Han Serif ExtraLight}
%\setCJKsansfont{Source Han Sans CN}
%\setCJKmonofont{Source Han Sans CN}
%\setCJKfamilyfont{boldsong}{Source Han Serif CN Heavy}
%\newcommand{\boldsong}{\CJKfamily{boldsong}}

\usepackage{silence}				%silvin
\WarningFilter{latex}{Text page}	% 过滤页面只有floats的警告

\long\def\sun#1{{\color{red} \textbf{[sun: #1]}}}