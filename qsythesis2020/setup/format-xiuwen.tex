...
\titlespacing{\section}{0pt}{3mm}{1.5mm}
\titleformat{\subsection}{\sihao}{\thesubsection}{0.5em}{}
\titlespacing{\subsection}{2.13em}{1.5mm}{-0.5mm}
...
% 参考文献格式, silvin修改，使用github最新的方式，已在package.tex中设置
%\bibliographystyle{bib/gbt7714-unsrt}
%\bibliographystyle{bib/gbt-7714-2015-numerical}	% template
...
% 定理正文和标题字体
\theoremstyle{plain}
\theoremheaderfont{\boldsong\rmfamily}
...
% 定义新的定理环境
%第一次出现这些之前,如果没有黑体字,会缩进2字符
% $\Diamond$
\theoremsymbol{} \newtheorem{definition}{\hskip 2em \boldsong 定义}[chapter]
\theoremsymbol{$\blacklozenge$} \newtheorem{example}{\hskip 2em \boldsong 例}[chapter]
\theoremsymbol{$\square$} \newtheorem{theorem}{\hskip 2em \boldsong 定理}[chapter]
\theoremsymbol{$\blacksquare$} \newtheorem*{proof}{\hskip 2em \boldsong 证明}

%========================================= FTE ===========================================
% 图表公式的编号为1-1格式，子图编号为 1) 的格式
...
\newcommand*{\citen}[1]{\begingroup \setcitestyle{numbers} \cite{#1} \endgroup}
